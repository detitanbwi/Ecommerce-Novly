...
<head>
    ...
    <title>@yield('title', 'Katalog') - Wirodayan Direct</title>
    <!-- Google Fonts: Inter -->
...
<body class="bg-slate-50 min-h-screen text-slate-800 flex flex-col">
    ...
    <header class="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            <a href="/" class="text-2xl font-extrabold tracking-tight text-indigo-600">Wirodayan.</a>
    ...
    <footer class="bg-white border-t border-slate-200 mt-auto py-8">
        <div class="max-w-6xl mx-auto px-4 text-center text-sm text-slate-500 font-medium">
            &copy; {{ date('Y') }} Wirodayan Direct. All rights reserved.
        </div>
    </footer>
</body>
