...
<body class="bg-slate-50 min-h-screen text-slate-800 flex flex-col">
    ...
    <!-- Footer -->
    <footer id="footer-contact" class="{{ request()->routeIs('home') ? 'bg-emerald-900 border-emerald-950' : 'bg-brand-800 border-brand-900' }} text-white mt-auto pt-12 pb-8 border-t">
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <p class="{{ request()->routeIs('home') ? 'text-emerald-100/80' : 'text-brand-200' }} text-sm leading-relaxed">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm {{ request()->routeIs('home') ? 'text-emerald-100/80' : 'text-brand-200' }}">
            ...
            <div>
                ...
                <div class="space-y-4 text-sm {{ request()->routeIs('home') ? 'text-emerald-100/80' : 'text-brand-200' }}">
                    <p class="flex items-start gap-3">
                        <svg class="w-5 h-5 shrink-0 {{ request()->routeIs('home') ? 'text-emerald-400' : 'text-brand-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
        ...
        <div class="max-w-6xl mx-auto px-4 text-center text-xs {{ request()->routeIs('home') ? 'text-emerald-400 border-emerald-800' : 'text-brand-400 border-brand-700/50' }} font-medium pt-8 border-t">
