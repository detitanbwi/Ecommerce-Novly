                ...
                <div class="space-y-4 text-sm text-emerald-200">
                    ...
                    <p class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/{{ \App\Models\Setting::where('key', 'whatsapp_number')->value('value') ?? '6285242927535' }}" target="_blank" class="hover:text-white transition-colors">
                            {{ \App\Models\Setting::where('key', 'company_phone')->value('value') ?? '+62 852-4292-7535' }} (WhatsApp)
                        </a>
                    </p>
                    <p class="flex items-center gap-3">
                        ...
                        <a href="mailto:{{ \App\Models\Setting::where('key', 'company_email')->value('value') ?? 'davidfinance4@gmail.co' }}" class="hover:text-white transition-colors">
                            {{ \App\Models\Setting::where('key', 'company_email')->value('value') ?? 'davidfinance4@gmail.co' }}
                        </a>
                    </p>
                </div>
            </div>
